...
install_base_packages() {
  ...
  sudo pacman -S --noconfirm firefox libreoffice-fresh thunderbird telegram-desktop obsidian audacity htop btop mc ktorrent krita obs-studio gwenview zsh papirus-icon-theme kde-cli-tools
}
